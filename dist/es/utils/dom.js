...
export const requestAF = w.requestAnimationFrame ||
...
export const parseEventOptions = (options) => {
    ...
    if (hasPassiveEventSupport) {
        ...
        return Boolean(isObject(options) ? options.capture : options);
    }
};
...
export const isDisabled = (el) => !isElement(el) || el.disabled || Boolean(getAttr(el, 'disabled')) || hasClass(el, 'disabled');
