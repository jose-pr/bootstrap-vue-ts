...
export const isPromise = (val) => !isUndefined(val) && !isNull(val) && isFunction(val.then) && isFunction(val.catch);
export const isVueElement = (val) => val.__vue__ && val instanceof HTMLElement;
