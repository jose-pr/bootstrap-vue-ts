...
export const observeDom = (
  el: Element | OurVue | null,
  callback: () => void,
  opts: {}
): MutationObserver | null => /* istanbul ignore next: difficult to test in JSDOM */ {
  // Handle cases where we might be passed a Vue instance
  el = el ? (el as OurVue).$el || el : null
  ...
  const obs = new MutationObs((mutations): void => {
    let changed = false
